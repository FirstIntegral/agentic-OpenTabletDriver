    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (principal.IsInRole(WindowsBuiltInRole.Administrator))
            {
                ...
                MessageBox.Show($"{App.ProductName} should not be run with administrator privileges.\n" +
                    "Some features may not work as intended, such as Plugin Manager and Tablet Debugger.\n" +
                    $"If you did not manually set {App.ProductName} to run with administrator privileges please enable UAC to resolve this.\n" +
